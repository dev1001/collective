...
*
* @param $node_path
*   The path to the node, generated below in collectivetwo_nice_menu_build
*/
function collectivetwo_menu_teaser($node_path) {
...
function collectivetwo_nice_menu_build($menu) {
  $output = '';
