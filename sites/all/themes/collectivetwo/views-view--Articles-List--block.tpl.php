...
<div class="view view-<?php print $css_name; ?> view-id-<?php print $name; ?> view-display-id-<?php print $display_id; ?> view-dom-id-<?php print $dom_id; ?>">
  ...
  <div id="bottom-module-left">
	
		<div id="insights-header">
            <a href="/insight/colIective-insights/">Collective Insights</a>
            <span class="insightSubheader">Advanced audience analytics and actionable insights for marketers</span>
    	</div>
